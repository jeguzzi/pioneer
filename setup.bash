...
--net=host --device=/dev/fw1:/dev/fw --device=/dev/$(readlink /dev/myrobot):/dev/myrobot --device=/dev/$(readlink /dev/mygps*):/dev/mygps  --device=/dev/input/js0 --device=/dev/$(readlink /dev/mylaser):/dev/mylaser \
jeguzzi/pioneer:dev'
